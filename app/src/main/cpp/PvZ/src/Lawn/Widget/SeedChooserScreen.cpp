...
static constexpr std::array<BuiltinAIPlantProfile, 43> kBuiltinAIPlantProfiles = {{
    {0, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_SUNSHROOM}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, 5, SEED_PEASHOOTER},
    {1, {SEED_SUNFLOWER, SEED_REPEATER, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, {SEED_SUNSHROOM, SEED_REPEATER, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, 5, SEED_REPEATER},
    {2, {SEED_SUNFLOWER, SEED_SNOWPEA, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_JALAPENO}, {SEED_SUNSHROOM, SEED_SNOWPEA, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_JALAPENO}, 4, SEED_SNOWPEA},
    {3, {SEED_SUNFLOWER, SEED_SCAREDYSHROOM, SEED_INSTANT_COFFEE, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB}, {SEED_SUNSHROOM, SEED_SCAREDYSHROOM, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, 3, SEED_SCAREDYSHROOM},
    {4, {SEED_SUNFLOWER, SEED_MELONPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_WALLNUT}, {SEED_SUNSHROOM, SEED_MELONPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_WALLNUT}, 3, SEED_MELONPULT},
    {5, {SEED_SUNFLOWER, SEED_BLOOMERANG, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_CELERY_STALKER}, {SEED_SUNSHROOM, SEED_BLOOMERANG, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_CELERY_STALKER}, 2, SEED_BLOOMERANG},
    {6, {SEED_SUNFLOWER, SEED_CABBAGEPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_JALAPENO}, {SEED_SUNSHROOM, SEED_CABBAGEPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_JALAPENO}, 2, SEED_CABBAGEPULT},
    {7, {SEED_SUNFLOWER, SEED_SPORESHROOM, SEED_INSTANT_COFFEE, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB}, {SEED_SUNSHROOM, SEED_SPORESHROOM, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, 2, SEED_SPORESHROOM},
    {8, {SEED_SUNFLOWER, SEED_KERNELPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, {SEED_SUNSHROOM, SEED_KERNELPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_ICEBERG_LETTUCE}, 1, SEED_KERNELPULT},
    {9, {SEED_SUNFLOWER, SEED_STARFRUIT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_PUMPKINSHELL}, {SEED_SUNSHROOM, SEED_STARFRUIT, SEED_POTATOMINE, SEED_SQUASH, SEED_CHERRYBOMB, SEED_PUMPKINSHELL}, 2, SEED_STARFRUIT},
    {10, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_DOOMSHROOM, SEED_CHILLY_PEPPER, SEED_HYPNOSHROOM, SEED_INSTANT_COFFEE}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_DOOMSHROOM, SEED_CHILLY_PEPPER, SEED_HYPNOSHROOM, SEED_POTATOMINE}, 3, SEED_PEASHOOTER},
    {11, {SEED_SUNFLOWER, SEED_SPORESHROOM, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_WALLNUT, SEED_SPIKEWEED}, {SEED_SUNSHROOM, SEED_SPORESHROOM, SEED_PUFFSHROOM, SEED_WALLNUT, SEED_SPIKEWEED, SEED_POTATOMINE}, 2, SEED_SPORESHROOM},
    {12, {SEED_SUNFLOWER, SEED_FUMESHROOM, SEED_INSTANT_COFFEE, SEED_WALLNUT, SEED_IMP_PEAR, SEED_DOOMSHROOM}, {SEED_SUNSHROOM, SEED_FUMESHROOM, SEED_WALLNUT, SEED_IMP_PEAR, SEED_POTATOMINE, SEED_SQUASH}, 1, SEED_FUMESHROOM},
    {13, {SEED_SUNFLOWER, SEED_SNOWPEA, SEED_BONK_CHOY, SEED_WALLNUT, SEED_SQUASH, SEED_IMP_PEAR}, {SEED_SUNSHROOM, SEED_SNOWPEA, SEED_BONK_CHOY, SEED_WALLNUT, SEED_SQUASH, SEED_IMP_PEAR}, 2, SEED_SNOWPEA},
    {14, {SEED_SUNFLOWER, SEED_STARFRUIT, SEED_GARLIC, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_POTATOMINE}, {SEED_SUNSHROOM, SEED_STARFRUIT, SEED_GARLIC, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_POTATOMINE}, 1, SEED_STARFRUIT},
    {15, {SEED_SUNFLOWER, SEED_REPEATER, SEED_WALLNUT, SEED_IMP_PEAR, SEED_SQUASH, SEED_SUNSHROOM}, {SEED_SUNSHROOM, SEED_REPEATER, SEED_WALLNUT, SEED_IMP_PEAR, SEED_SQUASH, SEED_POTATOMINE}, 2, SEED_REPEATER},
    {16, {SEED_SUNFLOWER, SEED_KERNELPULT, SEED_CELERY_STALKER, SEED_POTATOMINE, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_JALAPENO}, {SEED_SUNSHROOM, SEED_KERNELPULT, SEED_CELERY_STALKER, SEED_POTATOMINE, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_JALAPENO}, 1, SEED_KERNELPULT},
    {17, {SEED_SUNFLOWER, SEED_MELONPULT, SEED_POTATOMINE, SEED_SQUASH, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_JALAPENO}, {SEED_SUNSHROOM, SEED_MELONPULT, SEED_SCAREDYSHROOM, SEED_POTATOMINE, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_JALAPENO}, 2, SEED_MELONPULT},
    {18, {SEED_SUNFLOWER, SEED_SCAREDYSHROOM, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_DOOMSHROOM, SEED_SPIKEWEED}, {SEED_SUNSHROOM, SEED_SCAREDYSHROOM, SEED_PUFFSHROOM, SEED_DOOMSHROOM, SEED_SPIKEWEED, SEED_WALLNUT}, 1, SEED_SCAREDYSHROOM},
    {19, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_SUNSHROOM, SEED_ICEBERG_LETTUCE}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_ICEBERG_LETTUCE, SEED_POTATOMINE, SEED_WALLNUT}, 1, SEED_PEASHOOTER},
    {20, {SEED_SUNFLOWER, SEED_CACTUS, SEED_SPIKEWEED, SEED_POTATOMINE, SEED_WALLNUT, SEED_SQUASH}, {SEED_SUNSHROOM, SEED_CACTUS, SEED_SPIKEWEED, SEED_POTATOMINE, SEED_WALLNUT, SEED_SQUASH}, 1, SEED_CACTUS},
    {21, {SEED_SUNFLOWER, SEED_THREEPEATER, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_WALLNUT, SEED_CHILLY_PEPPER}, {SEED_SUNSHROOM, SEED_THREEPEATER, SEED_PUFFSHROOM, SEED_WALLNUT, SEED_CHILLY_PEPPER, SEED_POTATOMINE}, 1, SEED_THREEPEATER},
    {22, {SEED_SUNFLOWER, SEED_SNOWPEA, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_POTATOMINE, SEED_ICEBERG_LETTUCE}, {SEED_SUNSHROOM, SEED_SNOWPEA, SEED_PUFFSHROOM, SEED_POTATOMINE, SEED_ICEBERG_LETTUCE, SEED_WALLNUT}, 1, SEED_SNOWPEA},
    {23, {SEED_SUNFLOWER, SEED_REPEATER, SEED_CELERY_STALKER, SEED_JALAPENO, SEED_POTATOMINE, SEED_WALLNUT}, {SEED_SUNSHROOM, SEED_REPEATER, SEED_CELERY_STALKER, SEED_JALAPENO, SEED_POTATOMINE, SEED_WALLNUT}, 2, SEED_REPEATER},
    {24, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_ICEBERG_LETTUCE, SEED_WALLNUT}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_ICEBERG_LETTUCE, SEED_POTATOMINE, SEED_WALLNUT}, 2, SEED_PEASHOOTER},
    {25, {SEED_SUNFLOWER, SEED_FUMESHROOM, SEED_DOOMSHROOM, SEED_INSTANT_COFFEE, SEED_CHILLY_PEPPER, SEED_WALLNUT}, {SEED_SUNSHROOM, SEED_FUMESHROOM, SEED_DOOMSHROOM, SEED_CHILLY_PEPPER, SEED_POTATOMINE, SEED_WALLNUT}, 2, SEED_FUMESHROOM},
    {26, {SEED_SUNFLOWER, SEED_SNOWPEA, SEED_BONK_CHOY, SEED_SQUASH, SEED_WALLNUT, SEED_CHILLY_PEPPER}, {SEED_SUNSHROOM, SEED_SNOWPEA, SEED_BONK_CHOY, SEED_SQUASH, SEED_WALLNUT, SEED_CHILLY_PEPPER}, 2, SEED_SNOWPEA},
    {27, {SEED_SUNFLOWER, SEED_STARFRUIT, SEED_CHOMPER, SEED_CHERRYBOMB, SEED_WALLNUT, SEED_POTATOMINE}, {SEED_SUNSHROOM, SEED_STARFRUIT, SEED_CHOMPER, SEED_CHERRYBOMB, SEED_WALLNUT, SEED_POTATOMINE}, 1, SEED_STARFRUIT},
    {28, {SEED_SUNFLOWER, SEED_BLOOMERANG, SEED_DOOMSHROOM, SEED_HYPNOSHROOM, SEED_INSTANT_COFFEE, SEED_CHERRYBOMB, SEED_WALLNUT}, {SEED_SUNSHROOM, SEED_BLOOMERANG, SEED_DOOMSHROOM, SEED_HYPNOSHROOM, SEED_CHERRYBOMB, SEED_POTATOMINE, SEED_WALLNUT}, 1, SEED_BLOOMERANG},
    {29, {SEED_SUNFLOWER, SEED_SPORESHROOM, SEED_PUMPKINSHELL, SEED_SQUASH, SEED_INSTANT_COFFEE, SEED_CHERRYBOMB}, {SEED_SUNSHROOM, SEED_SPORESHROOM, SEED_PUMPKINSHELL, SEED_SQUASH, SEED_CHERRYBOMB, SEED_POTATOMINE}, 1, SEED_SPORESHROOM},
    {30, {SEED_SUNFLOWER, SEED_SNOWPEA, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_ICEBERG_LETTUCE, SEED_MAGNETSHROOM, SEED_POTATOMINE}, {SEED_SUNSHROOM, SEED_SNOWPEA, SEED_PUFFSHROOM, SEED_ICEBERG_LETTUCE, SEED_POTATOMINE, SEED_MAGNETSHROOM}, 1, SEED_SNOWPEA},
    {31, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_ICEBERG_LETTUCE, SEED_SUNSHROOM}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_PUFFSHROOM, SEED_ICEBERG_LETTUCE, SEED_POTATOMINE, SEED_WALLNUT}, 2, SEED_PEASHOOTER},
    {32, {SEED_SUNFLOWER, SEED_REPEATER, SEED_CELERY_STALKER, SEED_JALAPENO, SEED_WALLNUT, SEED_SUNSHROOM}, {SEED_SUNSHROOM, SEED_REPEATER, SEED_CELERY_STALKER, SEED_JALAPENO, SEED_WALLNUT, SEED_POTATOMINE}, 2, SEED_REPEATER},
    {33, {SEED_SUNFLOWER, SEED_POTATOMINE, SEED_PUFFSHROOM, SEED_SNOWPEA, SEED_INSTANT_COFFEE, SEED_ICEBERG_LETTUCE}, {SEED_SUNSHROOM, SEED_POTATOMINE, SEED_PUFFSHROOM, SEED_SNOWPEA, SEED_ICEBERG_LETTUCE, SEED_WALLNUT}, 2, SEED_SNOWPEA},
    {34, {SEED_SUNFLOWER, SEED_SPORESHROOM, SEED_PUFFSHROOM, SEED_SCAREDYSHROOM, SEED_INSTANT_COFFEE, SEED_DOOMSHROOM}, {SEED_SUNSHROOM, SEED_SPORESHROOM, SEED_PUFFSHROOM, SEED_SCAREDYSHROOM, SEED_DOOMSHROOM, SEED_WALLNUT}, 2, SEED_SPORESHROOM},
    {35, {SEED_SUNFLOWER, SEED_MELONPULT, SEED_POTATOMINE, SEED_WALLNUT, SEED_CHILLY_PEPPER, SEED_SQUASH}, {SEED_SUNSHROOM, SEED_MELONPULT, SEED_POTATOMINE, SEED_WALLNUT, SEED_CHILLY_PEPPER, SEED_SQUASH}, 2, SEED_MELONPULT},
    {36, {SEED_SUNFLOWER, SEED_REPEATER, SEED_SUNSHROOM, SEED_WALLNUT, SEED_SQUASH, SEED_CHILLY_PEPPER}, {SEED_SUNSHROOM, SEED_REPEATER, SEED_WALLNUT, SEED_SQUASH, SEED_CHILLY_PEPPER, SEED_POTATOMINE}, 3, SEED_REPEATER},
    {37, {SEED_SUNFLOWER, SEED_STARFRUIT, SEED_PUFFSHROOM, SEED_INSTANT_COFFEE, SEED_WALLNUT, SEED_CHERRYBOMB}, {SEED_SUNSHROOM, SEED_STARFRUIT, SEED_PUFFSHROOM, SEED_WALLNUT, SEED_CHERRYBOMB, SEED_POTATOMINE}, 1, SEED_STARFRUIT},
    ...
    {40, {SEED_SUNFLOWER, SEED_BLOOMERANG, SEED_WALLNUT, SEED_SQUASH, SEED_SUNSHROOM, SEED_GARLIC}, {SEED_SUNSHROOM, SEED_BLOOMERANG, SEED_WALLNUT, SEED_SQUASH, SEED_POTATOMINE, SEED_GARLIC}, 2, SEED_BLOOMERANG},
    {41, {SEED_SUNFLOWER, SEED_SCAREDYSHROOM, SEED_INSTANT_COFFEE, SEED_ICEBERG_LETTUCE, SEED_BONK_CHOY, SEED_HYPNOSHROOM}, {SEED_SUNSHROOM, SEED_SCAREDYSHROOM, SEED_ICEBERG_LETTUCE, SEED_BONK_CHOY, SEED_HYPNOSHROOM, SEED_WALLNUT}, 1, SEED_SCAREDYSHROOM},
    {42, {SEED_SUNFLOWER, SEED_PEASHOOTER, SEED_ICEBERG_LETTUCE, SEED_PUMPKINSHELL, SEED_CHERRYBOMB, SEED_JALAPENO}, {SEED_SUNSHROOM, SEED_PEASHOOTER, SEED_ICEBERG_LETTUCE, SEED_PUMPKINSHELL, SEED_CHERRYBOMB, SEED_JALAPENO}, 2, SEED_PEASHOOTER},
}};
