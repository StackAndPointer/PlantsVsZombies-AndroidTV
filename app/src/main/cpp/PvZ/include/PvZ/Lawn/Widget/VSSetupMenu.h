...
public:
    ...
    static constexpr SeedType msShufflePools[9][MAX_SEEDS_IN_POOL] = {
        ...
        // zombie pools
        {SEED_ZOMBIE_NORMAL, SEED_ZOMBIE_TRASHCAN, SEED_ZOMBIE_TRAFFIC_CONE, SEED_ZOMBIE_POLEVAULTER, SEED_ZOMBIE_NEWSPAPER, SEED_ZOMBIE_BOBSLED, SEED_ZOMBIE_YETI, SEED_NONE, SEED_NONE},
