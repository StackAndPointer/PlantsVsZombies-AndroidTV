...
public:
    ...
    static constexpr SeedType msShufflePools[9][8] = {
        ...
        {SEED_GRAVEBUSTER, SEED_SPIKEWEED, SEED_GARLIC, SEED_NONE, SEED_PEASHOOTER, SEED_PEASHOOTER, SEED_PEASHOOTER, SEED_PEASHOOTER},
        // zombie pools
        {SEED_ZOMBIE_NORMAL, SEED_ZOMBIE_TRASHCAN, SEED_ZOMBIE_TRAFFIC_CONE, SEED_ZOMBIE_POLEVAULTER, SEED_ZOMBIE_NEWSPAPER, SEED_ZOMBIE_EXPLOER, SEED_NONE, SEED_PEASHOOTER},
