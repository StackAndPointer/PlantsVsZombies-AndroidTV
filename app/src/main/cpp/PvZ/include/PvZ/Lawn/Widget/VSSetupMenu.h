...
public:
    ...
    static constexpr SeedType msShufflePools[9][8] = {
        ...
        {SEED_ZOMBIE_TRASHCAN, SEED_ZOMBIE_PAIL, SEED_ZOMBIE_DANCER, SEED_ZOMBIE_LADDER, SEED_ZOMBIE_FOOTBALL, SEED_ZOMBIE_BUNGEE, SEED_ZOMBIE_DIGGER, SEED_ZOMBIE_GIGA_POLEVAULTER},
