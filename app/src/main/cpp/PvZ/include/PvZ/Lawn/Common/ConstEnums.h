...
enum ShieldType { SHIELDTYPE_NONE, SHIELDTYPE_DOOR, SHIELDTYPE_NEWSPAPER, SHIELDTYPE_LADDER, SHIELDTYPE_TRASHCAN = 4, SHIELDTYPE_SUNDAY_EDITION };
enum StoreItem {
